...
from .views import (
    TestPlagiatListCreateView, TestPlagiatDetailView,
    LancerTestPlagiatView, LancerTestPlagiatThemeView,
    TestPlagiatThemeListView,
)
...
urlpatterns = [
    ...
    path('themes/', TestPlagiatThemeListView.as_view()),
]
